...
//     constructor(type, name, require, id, classes, placeholder, errorText) {
//         super(id, classes)
//         this.type = type
//         this.name = name
...
// const modal3 = new Inpute('submt', 'jk', false, "login-form", 'modal modal-green', "Вход", 'Жопа')
